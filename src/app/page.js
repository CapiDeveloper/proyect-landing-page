    ...
    <>
      ...
      <main className="w-11/12 md:w-[90%] mb-20 md:mb-0 mx-auto grid gap-5 md:grid-cols-2 md:place-content-start md:my-32">
        <div className="mb-24 md:mb-16">
          <h1 className={`${titleFont.className} text-3xl md:text-7xl mt-10 md:mt-0`}>A cleaner, fresher and safer home awaits ⤼ Invest in a healthier lifestyle!</h1>
      ...
      <section className="w-11/12 md:w-[90%] mx-auto md:grid md:grid-cols-2 place-content-center items-center my-10">
        <div>
          <h2 className={`${titleFont.className} text-3xl md:text-7xl mt-10 md:mt-0`}>The most Trusted ⤼ Reliable ⤼ Cleaning Service in CT and RI.</h2>
      ...
      <section className="bg-[#DFE0DB] pt-16 pb-10">
        <div className="w-11/12 md:w-[90%] mx-auto md:gap-10 md:grid md:grid-cols-2">
          ...
          <div>
            <h2 className={`${titleFont.className} text-3xl md:text-7xl mt-10 md:mt-0`}>We provide 100% Satisfaction Guarantee.</h2>
      ...
      <section className="w-11/12 md:w-[90%] mx-auto mt-5 md:my-16 md:grid md:grid-cols-2 gap-5 md:gap-14">
        ...
        <div className="gid place-content-center text-center">
          <h2 className={`${titleFont.className} text-3xl md:text-7xl mt-10 md:mt-0`}>We provide equipment suited for the highest hygiene demands</h2>
      ...
      <section className="w-11/12 my-10 md:w-[90%] mx-auto grid md:grid-cols-2 gap-5">
        ...
        <div>
          <h2 className={`${titleFont.className} text-3xl md:text-7xl mt-10 md:mt-0`}>Non-Toxic Products</h2>
      ...
      <section className="bg-black flex flex-col items-center gap-7 py-10">
        <div className="w-11/12 mx-auto flex flex-col gap-5">
          <h2 className={`${titleFont.className} text-2xl md:text-2xl lg:text-4xl text-center text-white`}>Get Started, Quick and Easy! </h2>
